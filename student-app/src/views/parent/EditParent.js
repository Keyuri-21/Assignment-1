...
import { API_BASE_URL, GETONEPARENT_ENDPOINT, UPDATEPARENT_ENDPOINT } from '../../redux/Constants.js';
...
const EditParent = () => {
  ...
  const submitForm = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:7000/api/updateParent/${id}`, updatedParentData);
      
      toast.success('Parent updated successfully', { position: 'top-right' });
      navigate('/parentList');
    } catch (error) {
